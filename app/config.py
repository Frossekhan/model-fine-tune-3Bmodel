...
class Settings(BaseSettings):
    model_config = ConfigDict(env_file=str(Path(__file__).resolve().parent.parent / ".env"), env_file_encoding="utf-8", extra="ignore")
    ...
    mongodb_db: str = Field(default="enterprise_assistant", env="MONGODB_DB")
    mongodb_collection: str = Field(default="conversations", env="MONGODB_COLLECTION")
